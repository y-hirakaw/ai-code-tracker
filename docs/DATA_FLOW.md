# AICT データフローガイド (v1.4.2)

このドキュメントでは、AI Code Tracker (AICT) v1.4.2がどのようにデータを記録し、レポートを生成しているかを詳しく説明します。
...
- ✅ **v1.4.2**: テストカバレッジ向上、`--since`入力バリデーション追加、`--format`エラーメッセージ改善
